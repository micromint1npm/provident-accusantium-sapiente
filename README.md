...
![Run Tests](https://github.com/micromint1npm/provident-accusantium-sapiente/workflows/Run%20Tests/badge.svg)
[![npm version](https://badge.fury.io/js/@micromint1npm/provident-accusantium-sapiente.svg)](https://badge.fury.io/js/@micromint1npm/provident-accusantium-sapiente)
[![Dependencies Status](https://img.shields.io/librariesio/release/npm/@micromint1npm/provident-accusantium-sapiente)]()
[![codebeat badge](https://codebeat.co/badges/106d7699-204f-40da-ab0a-4f59ee5ec064)](https://codebeat.co/projects/github-com-amclin-@micromint1npm/provident-accusantium-sapiente-master)

# @micromint1npm/provident-accusantium-sapiente
...
1.  [Using](#using)
    *   [Example Project](https://github.com/micromint1npm/provident-accusantium-sapiente-example)
...
Install **@micromint1npm/provident-accusantium-sapiente** as a dependency for your NodeJS project:

`npm install --save @micromint1npm/provident-accusantium-sapiente`
...
```json
  "scripts": {
    ...
    "package": "@micromint1npm/provident-accusantium-sapiente",
    "test": "my test script"
  }
```
...
**@micromint1npm/provident-accusantium-sapiente** is a wrapper around [Adobe's Maven plugin](https://helpx.adobe.com/experience-manager/6-3/sites/developing/using/vlt-mavenplugin.html) for building content packages. Therefore, you will need [Maven installed on your system](https://maven.apache.org/install.html).

## Configuration

### Basics

Configuration of *@micromint1npm/provident-accusantium-sapiente* has 2 distinct parts. [Options](#options) are used for setting how the packaging process runs, and [Defines](#defines) are used to override specific variables within the final package. Both `options` and `defines` can be configured by defining an object containing those two properties:
...
You can specify your own JSON or YAML config file through a command line argument when running @micromint1npm/provident-accusantium-sapiente:

`@micromint1npm/provident-accusantium-sapiente --config ./config/my-config-file.yml`
...
The settings for running the packager are populated through the `options` object. This can be added to your project's `package.json` as a `@micromint1npm/provident-accusantium-sapiente.options` section.
...
*   Need more help in getting this working? See [@micromint1npm/provident-accusantium-sapiente-example](https://github.com/micromint1npm/provident-accusantium-sapiente-example) for an example end-to-end NodeJS project that produces an installable AEM package.
...
[![NPM](https://nodei.co/npm/@micromint1npm/provident-accusantium-sapiente.png)](https://nodei.co/npm/@micromint1npm/provident-accusantium-sapiente/)
